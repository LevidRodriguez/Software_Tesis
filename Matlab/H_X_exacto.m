...
fclose(file);
figure;
plot(H(:,4),H(:,2),'.','LineWidth',2,'markersize',10);      %100cm
grid minor
hold on
...
plot(H(1:160,6),H(1:160,2),'.','LineWidth',2,'markersize',10);      %90cm
...
plot(H(1:169,8),H(1:169,2),'.','LineWidth',2,'markersize',10);      %80cm
...
plot(H(:,14),H(:,2),'.','LineWidth',2,'markersize',10);      %50cm
